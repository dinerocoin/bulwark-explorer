    ...
    <Card title="Estimated Earnings (COIN/BTC/USD)">
      <div className="row">
        ...
        <div className="col-sm-12 col-md-9">
          { nbtc(day) } DIN / { nbtc(day * coin.btc) } BTC / { nusd(day * coin.usd) } USD
        </div>
      </div>
      <div className="row">
        <div className="col-sm-12 col-md-3">
        ...
        <div className="col-sm-12 col-md-9">
          { nbtc(week) } DIN / { nbtc(week * coin.btc) } BTC / { nusd(week * coin.usd) } USD
        </div>
      </div>
      <div className="row">
        <div className="col-sm-12 col-md-3">
        ...
        <div className="col-sm-12 col-md-9">
          { nbtc(month) } DIN / { nbtc(month * coin.btc) } BTC / { nusd(month * coin.usd) } USD
        </div>
      </div>
      <div className="row">
        <div className="col-sm-12 col-md-3">
        ...
        <div className="col-sm-12 col-md-9">
          { nbtc(year) } DIN / { nbtc(year * coin.btc) } BTC / { nusd(year * coin.usd) } USD
        </div>
      </div>
      <div className="row">
        <div className="col">
