          ...
          <div className="card--address">
            ...
            <div className="card__row">
              ...
              <span className="card__result">
                -{ numeral(this.props.received - this.props.balance).format('0,0.0000') } DIN
              </span>
            </div>
            <div className="card__row">
              <span className="card__label">
              ...
              <span className="card__result">
                +{ numeral(this.props.received).format('0,0.0000') } DIN
              </span>
            </div>
            <div className="card__row">
              <span className="card__label">
              ...
              <span className="card__result">
                { numeral(this.props.balance).format('0,0.0000') } DIN
              </span>
            </div>
          </div>
        </div>
