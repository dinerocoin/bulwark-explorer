      ...
      <div>
        ...
        <div className="row">
          ...
          <div className="col-sm-8">
            { numeral(vX.subsidy).format('0,0.0000') } DIN
          </div>
          <div className="col-sm-4">
            <b>PoS:</b>
          </div>
          <div className="col-sm-8">
            { numeral(vX.posSubsidy).format('0,0.0000') } DIN
          </div>
          <div className="col-sm-4">
            <b>Masternode:</b>
          </div>
          <div className="col-sm-8">
            { numeral(vX.mnSubsidy).format('0,0.0000') } DIN
          </div>
          <div className="col-sm-4">
            <b>Calculation Amount:</b>
          </div>
          <div className="col-sm-8">
            { numeral(this.state.amount).format('0,0.0000') } DIN
          </div>
        </div>
        <hr />
        <br />
