...
server {
    ...
    #server_name insights.dinerocoin.org;
    server_name _;
    ...
    #ssl_certificate /etc/letsencrypt/live/insights.dinerocoin.org/fullchain.pem; # managed by Certbot
    #ssl_certificate_key /etc/letsencrypt/live/insights.dinerocoin.org/privkey.pem; # managed by Certbot
    #include /etc/letsencrypt/options-ssl-nginx.conf; # managed by Certbot
    #ssl_dhparam /etc/letsencrypt/ssl-dhparams.pem; # managed by Certbot
}

#server {
#    if ($host = insights.dinerocoin.org) {
